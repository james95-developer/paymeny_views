          ...
          <tr valign="top">
            ...
            <td class="forminp forminp-text">
              <select class="regular-text code" name="flw_rave_options[method]">
                ...
                <option value="barter" <?php selected( $method, 'barter' ) ?>>Barter Only</option>
                <option value="mpesa" <?php selected( $method, 'mpesa' ) ?>>Mpesa Only (for KES)</option>
                <option value="ussd" <?php selected( $method, 'ussd' ) ?>>USSD Only</option>
                <option value="mobilemoneyuganda" <?php selected( $method, 'mobilemoneyuganda' ) ?>>MobileMoney UGX Only</option>
                <option value="mobilemoneyrwanda" <?php selected( $method, 'mobilemoneyrwanda' ) ?>>MobileMoney RWD Only</option>
                <option value="mobilemoneyzambia" <?php selected( $method, 'mobilemoneyzambia' ) ?>>MobileMoney ZMB Only</option>
                <option value="mobilemoneytanzania" <?php selected( $method, 'mobilemoneytanzania' ) ?>>MobileMoney TZS Only</option>
              </select>
          ...
          <tr valign="top">
            ...
            <td class="forminp forminp-text">
              <select class="regular-text code" name="flw_rave_options[currency]">
                ...
                <option value="RWF" <?php selected($currency, 'RWF') ?>>RWF</option>
                <option value="TZS" <?php selected($currency, 'TZS') ?>>TZS</option>
                <option value="ZMW" <?php selected($currency, 'ZMW') ?>>ZMW</option>
                <option value="XOF" <?php selected($currency, 'XOF') ?>>XOF</option>
                <option value="XAF" <?php selected($currency, 'XAF') ?>>XAF</option>
              </select>
