      ...
      <table class="form-table">
        <tbody>
          ...
          <tr valign="top">
            ...
            <td class="forminp forminp-text">
              <input class="regular-text code" type="text" name="extra_form_options[extra_field_1]" value="<?php echo esc_attr( $payment_forms->get_option_value( 'extra_field_1' ) ); ?>" placeholder="language,structure"/>
              <p class="description">ADD A TEXT FIELD eg:name,address. To hide fields add "-h" for example:name-h,firstname-h,lastname-h</p>
            </td>
          </tr>
          <!-- Extra Yes/No Fields -->
          <tr valign="top">
